...
export default function DefiChallengeBanner() {
  return (
    <div className="relative w-full overflow-hidden rounded-2xl bg-gradient-to-r from-[#0f172a] via-[#1e1b4b] to-[#0f172a] border border-indigo-900/60 shadow-lg">
      <div className="absolute inset-0 bg-gradient-to-r from-yellow-500/5 via-purple-500/10 to-yellow-500/5 pointer-events-none" />
      <div className="absolute left-0 top-0 h-full w-16 bg-gradient-to-r from-[#0f172a] to-transparent z-10 pointer-events-none" />
      <div className="absolute right-0 top-0 h-full w-32 bg-gradient-to-l from-[#0f172a] to-transparent z-10 pointer-events-none" />
